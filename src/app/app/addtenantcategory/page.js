...
export default function AddTenantCategoryPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("/api/tenant-categories", formData);
  ...
  return (
    <div className="p-8">
      <h1 className="text-3xl font-bold mb-6">Add Website Category</h1>
